    ...
    public class Patchlist
    {
        ...
        public Patchlist(String line, Management management)
        {
            ...
            if (this._line.Count > 3)
            {
                ...
                this.patchBase = management.Get(this._line[3][0]);
            }
            else
            {
                this.hash = this._line[2];
                this.size = UInt64.Parse(this._line[1]);
                this.flags = "p";
                this.management = "p";
                this.url = management.Get('p') + this._line[0];
                this.patchBase = management.Get('p');
            }
        }
